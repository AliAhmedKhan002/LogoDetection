...
def train(hyp,  # path/to/hyp.yaml or hyp dictionary
    ...
    # f=open('dataset/data/labels/classes.txt','r')
    # names=f.read().split()
    # f.close()
    # print(names)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=r"Model_checkpoint\weights\best.pt", help='initial weights path')
    parser.add_argument('--cfg', type=str, default='', help='model.yaml path')
    parser.add_argument('--data', type=str, default=r"D:\Forbmax User Data\waqar sahi\Dataset\Logo Dataset\data.yaml", help='dataset.yaml path')
...
if __name__ == "__main__":
    # process_data(root_dir=r"D:\Forbmax User Data\waqar sahi\Dataset\Logo Dataset")
    opt = parse_opt()
    main(opt)
